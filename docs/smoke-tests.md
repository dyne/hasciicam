...
Open `http://127.0.0.1:8000/`, start a real camera, and verify live VGA9 ASCII
on the 640×477 canvas. Rendering automatically falls back from SDL/WebGL to SDL
software and then native Canvas 2D. Stop or close the page and confirm camera
release.
